...
namespace CatJson
{
    ...
    {
        private static TestJson1_Root Parse_TestJson1_Root()
        {
            ...
            JsonParser.ParseJsonObjectProcedure(obj, null, (userdata1, userdata2, key, nextTokenType) =>
            {
				...
				{
				temp.item = Parse_TestJson1_Item();
				}
				...
				JsonParser.ParseJsonArrayProcedure(list, null, (userdata11, userdata21, nextTokenType1) =>
				{
				((List<TestJson1_Item>)userdata11).Add(Parse_TestJson1_Item());
				});
				temp.itemList = list;
				}
				...
				JsonParser.ParseJsonObjectProcedure(dict, null, (userdata11, userdata21,key1, nextTokenType1) =>
				{
				((Dictionary<string, TestJson1_Item>)userdata11).Add(key1.ToString(),Parse_TestJson1_Item());
				});
				temp.itemDict = dict;
				}
